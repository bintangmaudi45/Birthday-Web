...
const AUDIO_SRC = `${import.meta.env.BASE_URL}assets/noticing-the-rain.mp3`;
...
export default function SongMission({ onComplete }: Props) {
  ...
  const handlePlay = useCallback(async () => {
    ...
    if (!audio) {
      console.error('Planet 4: audio element tidak ditemukan.');
      return;
    }
    ...
    try {
      ...
      console.log(
        'Planet 4 MP3 berhasil diputar:',
        AUDIO_SRC
      );
    } catch (error) {
      console.error(
        'Planet 4: MP3 gagal diputar.',
        error
      );

      console.error(
        'Planet 4 audio source:',
        AUDIO_SRC
      );
  ...
  const handleAudioError = useCallback(() => {
    ...
    console.error(
      'Planet 4: Tidak bisa memuat MP3.'
    );
            ...
            <div
              ...
              style={{
                ...
                transform:
                  `rotate(${(i - 2) * 8}deg)`,
                animation:
                  `lightRay ${4 + i}s ease-in-out infinite`,
                animationDelay:
                  `${i * 0.5}s`,
              }}
            />
        ...
        {phase === 'intro' && (
          ...
          >
            ...
            >
              ...
              <br />
              Turn off the website sound, then press play.
            </p>
          </div>
        )}
